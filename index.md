...
![Build
Status](https://github.com/ropensci/skynet/workflows/R-CMD-check/badge.svg)[![CRAN_Status_Badge](http://www.r-pkg.org/badges/version/skynet)](https://cran.r-project.org/package=skynet)
![](https://cranlogs.r-pkg.org/badges/skynet?color=brightgreen)[![Coverage
...
downloaded at <https://www.transtats.bts.gov/Fields.asp?gnoyr_VQ=FLM>
and <https://www.transtats.bts.gov/Fields.asp?gnoyr_VQ=FKF> respectively
while the T100 data can be found here
...
<https://www.transtats.bts.gov/Fields.asp?gnoyr_VQ=FLM> and
<https://www.transtats.bts.gov/Fields.asp?gnoyr_VQ=FKF> respectively.
